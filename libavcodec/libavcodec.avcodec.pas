...
uses
  libavutil.samplefmt, libavutil.avutil;
//, libavutil.attributes, libavutil.buffer,
//  libavutil.cpu, libavutil.channel_layout, libavutil.dict, libavutil.frame,
//  libavutil.log, libavutil.pixfmt, libavutil.rational;
...
/**
 * H.263 advanced intra coding / MPEG-4 AC predictio
 *)
...
{$ifndef FF_API_DEBUG_MV}
  FF_DEBUG_VIS_MV_P_FOR  = $00000001; //visualize forward predicted MVs of P = frames;
  FF_DEBUG_VIS_MV_B_FOR  = $00000002; //visualize forward predicted MVs of B = frames;
  FF_DEBUG_VIS_MV_B_BACK = $00000004; //visualize backward predicted MVs of B =  = ;;
{$endif}
...
type
  ...
  TProcDrawHorizBand = procedure(s: PAVCodecContext; const src: PAVFrame;
    offset: Pointer; y, type_, height: Integer); cdecl;

  TProcGetFormat = function(S: PAVCodecContext; const
    fmt: PAVPixelFormat): TAVPixelFormat; cdecl;

  TProcGetBuffer2 = function(s: PAVCodecContext; frame: PAVFrame;
    flags: Integer): Integer; cdecl;

  TProcRTPCallback = procedure(avctx: PAVCodecContext; data: PByte;
    size: Integer; mb_nb: Integer); cdecl;

  TProcExecuteFunc = function(C2: PAVCodecContext; arg: Pointer): Integer; cdecl;

  TProcExecute = function(c: PAVCodecContext; func: TProcExecuteFunc;
    arg2: Pointer; var ret: Integer; count: Integer;
    size: Integer): Integer; cdecl;

  TProcExecute2Func = function(C2: PAVCodecContext; arg: Pointer; jobnr: Integer;
    threadnr: Integer): Integer; cdecl;
  TProcExecute2 = function(c: PAVCodecContext; arg2: Pointer; var ret: Integer;
...
{$ifdef FF_API_STREAM_CODEC_TAG}
     ...
     *)
    stream_codec_tag: Cardinal deprecated;
{$endif}
...
//                            int y, int type, int height);
    draw_horiz_band: TProcDrawHorizBand;
...
{$ifdef FF_API_RC_STRATEGY}
    (** @deprecated use codec private option instead *)
    rc_strategy: Integer deprecated;
//#define FF_RC_STRATEGY_XVID 1
{$endif}

{$ifdef FF_API_PRIVATE_OPT}
    (** @deprecated use encoder private options instead *)
    b_frame_strategy: Integer deprecated;
{$endif}
...
{$if FF_API_PRIVATE_OPT}
    (** @deprecated use encoder private options instead *)
     prediction_method: Integer deprecated;
{$endif}
...
{$ifdef FF_API_QUANT_BIAS}
     ...
     *)
    intra_quant_bias: Integer deprecated;

    (**
     * @deprecated use encoder private option instead
     *)
    inter_quant_bias: Integer deprecated;
{$endif}
...
{$ifdef FF_API_XVMC}
     ...
     *)
    xvmc_acceleration: Integer deprecated;
{$endif (* FF_API_XVMC *)}
...
{$ifdef FF_API_PRIVATE_OPT}
    (** @deprecated use encoder private options instead *)
    scenechange_threshold: Integer deprecated;

    (** @deprecated use encoder private options instead *)
    noise_reduction: Integer deprecated;
{$endif}
...
{$ifdef FF_API_MPV_OPT}
     ...
     * @deprecated this field is unused
     *)
    me_threshold: Integer deprecated;

    (**
     * @deprecated this field is unused
     *)
    mb_threshold: Integer deprecated;
{$endif}
...
{$ifdef FF_API_PRIVATE_OPT}
    (** @deprecated use encoder private options instead *)
    b_sensitivity: Integer deprecated;
{$endif}
...
//   int (*get_buffer2)(struct AVCodecContext *s, AVFrame *frame, int flags);
     ...
     *)
    refcounted_frames: Integer deprecated;
...
{$ifdef FF_API_MPV_OPT}
     ...
     * @deprecated use encoder private options instead
     *)
    rc_qsquish: Single deprecated;

    rc_qmod_amp: Single deprecated;
    rc_qmod_freq: Integer deprecated;
{$endif}
...
{$ifdef FF_API_MPV_OPT}
     ...
     * @deprecated use encoder private options instead
     *)
    rc_buffer_aggressivity: Single deprecated;

    rc_initial_cplx: Single deprecated;
{$endif}
...
{$ifdef FF_API_CODER_TYPE}
     ...
     * @deprecated use encoder private options instead
     *)
    coder_type: Integer deprecated;
{$endif (* FF_API_CODER_TYPE *)}


{$ifdef FF_API_PRIVATE_OPT}
    (** @deprecated use encoder private options instead *)
    context_model: Integer deprecated;
{$endif}
...
{$ifdef FF_API_MPV_OPT}
     ...
     * @deprecated use encoder private options instead
     *)
    lmin: Integer deprecated;

    (**
     * @deprecated use encoder private options instead
     *)
    lmax: Integer deprecated;
{$endif}

{$ifdef FF_API_PRIVATE_OPT}
    (** @deprecated use encoder private options instead *)
    frame_skip_threshold: Integer deprecated;

    (** @deprecated use encoder private options instead *)
    frame_skip_factor: Integer deprecated;

    (** @deprecated use encoder private options instead *)
    frame_skip_exp: Integer deprecated;

    (** @deprecated use encoder private options instead *)
    frame_skip_cmp: Integer deprecated;
...
{$ifdef FF_API_PRIVATE_OPT}
    (** @deprecated use encoder private options instead *)
    min_prediction_order: Integer deprecated;

    (** @deprecated use encoder private options instead *)
    max_prediction_order: Integer deprecated;

    (** @deprecated use encoder private options instead *)
    timecode_frame_start: Int64 deprecated;
{$endif}
...
//void (*rtp_callback)(struct AVCodecContext *avctx, void *data, int size, int mb_nb);
    rtp_callback: TProcRTPCallback deprecated;
{$endif}

{$ifdef FF_API_PRIVATE_OPT}
    (** @deprecated use encoder private options instead *)
    rtp_payload_size: Integer deprecated;   (* The size of the RTP payload: the coder will  *)
...
{$ifdef FF_API_STAT_BITS}
    ...
    mv_bits: Integer deprecated;
    header_bits: Integer deprecated;
    i_tex_bits: Integer deprecated;
    p_tex_bits: Integer deprecated;
    i_count: Integer deprecated;
    p_count: Integer deprecated;
    skip_count: Integer deprecated;
    misc_bits: Integer deprecated;

    (** @deprecated this field is unused *)
    frame_bits: Integer deprecated;
{$endif}
...
{$ifdef FF_API_SIDEDATA_ONLY_PKT}
     ...
     *)
    side_data_only_packets: Integer deprecated;
{$endif}
...
//AVRational av_codec_get_pkt_timebase         (const AVCodecContext *avctx);
  function av_codec_get_pkt_timebase(const avctx: PAVCodecContext): TAVRational;cdecl; external LIB_LIBAVCODEC;
//void       av_codec_set_pkt_timebase         (AVCodecContext *avctx, AVRational val);
  procedure av_codec_set_pkt_timebase(avctx: PAVCodecContext; val: TAVRational);cdecl; external LIB_LIBAVCODEC;

//const AVCodecDescriptor *av_codec_get_codec_descriptor(const AVCodecContext *avctx);
  function av_codec_get_codec_descriptor(const avctx: PAVCodecContext): PAVCodecDescriptor;
                                                                                cdecl; external LIB_LIBAVCODEC;
//void                     av_codec_set_codec_descriptor(AVCodecContext *avctx, const AVCodecDescriptor *desc);
  procedure av_codec_set_codec_descriptor(avctx: PAVCodecContext;
    const desc: PAVCodecDescriptor);                                            cdecl; external LIB_LIBAVCODEC;

//unsigned av_codec_get_codec_properties(const AVCodecContext *avctx);
  function av_codec_get_codec_properties(const avctx: PAVCodecContext): Cardinal; cdecl; external LIB_LIBAVCODEC;

//int  av_codec_get_lowres(const AVCodecContext *avctx);
  function av_codec_get_lowres(const avctx: PAVCodecContext): Integer;          cdecl; external LIB_LIBAVCODEC;
//void av_codec_set_lowres(AVCodecContext *avctx, int val);
  procedure av_codec_set_lowres(avctx: PAVCodecContext; val: Integer);          cdecl; external LIB_LIBAVCODEC;

//int  av_codec_get_seek_preroll(const AVCodecContext *avctx);
  function av_codec_get_seek_preroll(const avctx: PAVCodecContext): Integer;    cdecl; external LIB_LIBAVCODEC;
//void av_codec_set_seek_preroll(AVCodecContext *avctx, int val);
  procedure av_codec_set_seek_preroll(avctx: PAVCodecContext; val: Integer);    cdecl; external LIB_LIBAVCODEC;

//uint16_t *av_codec_get_chroma_intra_matrix(const AVCodecContext *avctx);
  function av_codec_get_chroma_intra_matrix(const avctx: PAVCodecContext): PWord; cdecl; external LIB_LIBAVCODEC;
//void av_codec_set_chroma_intra_matrix(AVCodecContext *avctx, uint16_t *val);
  procedure av_codec_set_chroma_intra_matrix(avctx: PAVCodecContext; val: PWord); cdecl; external LIB_LIBAVCODEC;
 ...
 *)
type
  TProcInitThreadCopy = function(avctx: PAVCodecContext): Integer; cdecl;
  TProcUpdateThreadContext = function(dst: PAVCodecContext;
    const src: PAVCodecContext): Integer; cdecl;
  TProcInitStaticData = procedure(codec: PAVCodec); cdecl;
  TProcAVInit = function(avctx: PAVCodecContext): Integer; cdecl;
  TProcEncodeSub = function(avctx: PAVCodecContext; buf: PByte;
    buf_size: Integer; const sub: PAVSubtitle): Integer; cdecl;

  TProcAVencode2 = function(avctx: PAVCodecContext; avpkt: PAVPacket;
    const frame: PAVFrame; var got_packet_ptr: Integer): Integer; cdecl;
  TProcAVDecode = function(avctx: PAVCodecContext; outdata: Pointer;
    var outdata_size: Integer; avpkt: PAVPacket): Integer; cdecl;
  TProcAVClose = function(avctx: PAVCodecContext): Integer; cdecl;

  TProcSendFrame = function(avctx: PAVCodecContext;
    const frame: PAVFrame): Integer; cdecl;

  TProcReceivePacket = function(avctx: PAVCodecContext;
    avpkt: PAVPacket): Integer; cdecl;

  TProcReceiveFrame = function(avctx: PAVCodecContext;
    frame: PAVFrame): Integer; cdecl;

  TProcAVflush = procedure(avctx: PAVCodecContext); cdecl;
...
//int (*init_thread_copy)(AVCodecContext *);
    init_thread_copy: TProcInitThreadCopy;
    (**
...
//int (*update_thread_context)(AVCodecContext *dst, const AVCodecContext *src);
    update_thread_context: TProcUpdateThreadContext;
...
//void (*init_static_data)(struct AVCodec *codec);
    init_static_data: TProcInitStaticData;
//int (*init)(AVCodecContext *);
    init: TProcAVInit;
//int (*encode_sub)(AVCodecContext *, uint8_t *buf, int buf_size,
//                      const struct AVSubtitle *sub);
    encode_sub: TProcEncodeSub;
...
//                   int *got_packet_ptr);
    encode2: TProcAVencode2;
//int (*decode)(AVCodecContext *, void *outdata, int *outdata_size, AVPacket *avpkt);
    decode: TProcAVDecode;
...
//int (*send_frame)(AVCodecContext *avctx, const AVFrame *frame);
    send_frame: TProcSendFrame;
//int (*receive_packet)(AVCodecContext *avctx, AVPacket *avpkt);
    receive_packet: TProcReceivePacket;
...
//int (*receive_frame)(AVCodecContext *avctx, AVFrame *frame);
    receive_frame: TProcReceiveFrame;
    (**
     * Flush buffers.
...
//int av_codec_get_max_lowres(const AVCodec *codec);
  function av_codec_get_max_lowres(const codec: PAVCodec): Integer;             cdecl; external LIB_LIBAVCODEC;
 ...
 *)
type
  TProcAllocFrame = function(avctx: PAVCodecContext; frame: PAVFrame): Integer; cdecl;
  TProcStartFrame= function(avctx: PAVCodecContext; const buf: PByte;
    buf_size: Cardinal): Integer; cdecl;
  TProcDecodeSlice = function(avctx: PAVCodecContext; const buf: PByte;
    buf_size: Cardinal): Integer; cdecl;
  TProcEndFrame = function(avctx: PAVCodecContext): Integer; cdecl;
  TProcDecodeMb = procedure(s: PMpegEncContext); cdecl;
  TProcInit = function(avctx: PAVCodecContext): Integer; cdecl;
  TProcUninit = function(avctx: PAVCodecContext): Integer; cdecl;
...
type
  ...
  TAVPicture = record
    data: PByte deprecated;
    linesize: Integer deprecated;
  end;
...
type
  PPAVSubtitleRect = ^^TAVSubtitleRect;
...
//AVCodec *av_codec_next(const AVCodec *c);
  function av_codec_next(const c: PAVCodec): PAVCodec;                          cdecl; external LIB_LIBAVCODEC;

(**
 * Return the LIBAVCODEC_VERSION_INT constant.
 *)
//unsigned avcodec_version(void);
  function avcodec_version: Cardinal;                                           cdecl; external LIB_LIBAVCODEC;

(**
 * Return the libavcodec build-time configuration.
 *)
//const char *avcodec_configuration(void);
  function avcodec_configuration: PAnsiChar;                                    cdecl; external LIB_LIBAVCODEC;

(**
 * Return the libavcodec license.
 *)
//const char *avcodec_license(void);
  function avcodec_license: PAnsiChar;                                          cdecl; external LIB_LIBAVCODEC;
...
//void avcodec_register(AVCodec *codec);
  procedure avcodec_register(codec: PAVCodec);                                  cdecl; external LIB_LIBAVCODEC;
...
//AVCodecContext *avcodec_alloc_context3(const AVCodec *codec);
  function avcodec_alloc_context3(const codec: PAVCodec): PAVCodecContext;      cdecl; external LIB_LIBAVCODEC;
...
//void avcodec_free_context(AVCodecContext **avctx);
  procedure avcodec_free_context(avctx: PPAVCodecContext);                      cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_get_context_defaults3(AVCodecContext *s, const AVCodec *codec);
  function avcodec_get_context_defaults3(s: PAVCodecContext;
    const codec: PAVCodec): Integer;                                            cdecl; external LIB_LIBAVCODEC;
{$endif}
...
//int avcodec_copy_context(AVCodecContext *dest, const AVCodecContext *src);
  function avcodec_copy_context(dest: PAVCodecContext;
    const src: PAVCodecContext): Integer;                                       cdecl; external LIB_LIBAVCODEC;
{$endif}
...
//void avcodec_parameters_free(AVCodecParameters **par);
  procedure avcodec_parameters_free(par: PPAVCodecParameters);                  cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_parameters_copy(AVCodecParameters *dst, const AVCodecParameters *src);
  function avcodec_parameters_copy(dst: PAVCodecParameters;
    const src: PAVCodecParameters): Integer;                                    cdecl; external LIB_LIBAVCODEC;
...
//                                    const AVCodecContext *codec);
  function avcodec_parameters_from_context(par: PAVCodecParameters;
    const codec: PAVCodecContext): Integer;                                     cdecl; external LIB_LIBAVCODEC;
...
//                                  const AVCodecParameters *par);
  function avcodec_parameters_to_context(codec: PAVCodecContext;
    const par: PAVCodecParameters): Integer;                                    cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_open2(AVCodecContext *avctx, const AVCodec *codec, AVDictionary **options);
  function avcodec_open2(avctx: PAVCodecContext; const codec: PAVCodec;
    options: PPAVDictionary): Integer;                                          cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_close(AVCodecContext *avctx);
  function avcodec_close(avctx: PAVCodecContext): Integer;                      cdecl; external LIB_LIBAVCODEC;
...
//void avsubtitle_free(AVSubtitle *sub);
  procedure avsubtitle_free(sub: PAVSubtitle);                                  cdecl; external LIB_LIBAVCODEC;
...
//AVPacket *av_packet_clone(const AVPacket *src);
  function av_packet_clone(const src: PAVPacket): PAVPacket;                    cdecl; external LIB_LIBAVCODEC;
...
//void av_packet_free(AVPacket **pkt);
  procedure av_packet_free(pkt: PPAVPacket);                                    cdecl; external LIB_LIBAVCODEC;
...
//void av_init_packet(AVPacket *pkt);
  procedure av_init_packet(pkt: PAVPacket);                                     cdecl; external LIB_LIBAVCODEC;
...
//int av_new_packet(AVPacket *pkt, int size);
  function av_new_packet(pkt: PAVPacket; size: Integer): Integer;               cdecl; external LIB_LIBAVCODEC;
...
//void av_shrink_packet(AVPacket *pkt, int size);
  procedure av_shrink_packet(pkt: PAVPacket; size: Integer);                    cdecl; external LIB_LIBAVCODEC;
...
//int av_grow_packet(AVPacket *pkt, int grow_by);
  function av_grow_packet(pkt: PAVPacket; grow_by: Integer): Integer;           cdecl; external LIB_LIBAVCODEC;
...
//int av_packet_from_data(AVPacket *pkt, uint8_t *data, int size);
  function av_packet_from_data(pkt: PAVPacket; data: PByte;
    size: Integer): Integer;                                                    cdecl; external LIB_LIBAVCODEC;
...
//int av_dup_packet(AVPacket *pkt);
  function av_dup_packet(pkt: PAVPacket): Integer deprecated;                   cdecl; external LIB_LIBAVCODEC;
(**
...
//int av_copy_packet(AVPacket *dst, const AVPacket *src);
  function av_copy_packet(dst: PAVPacket; const src: PAVPacket): Integer; deprecated; cdecl; external LIB_LIBAVCODEC;
...
//int av_copy_packet_side_data(AVPacket *dst, const AVPacket *src);
  function av_copy_packet_side_data(dst: PAVPacket;
    const src: PAVPacket): Integer; deprecated;                                 cdecl; external LIB_LIBAVCODEC;
...
//void av_free_packet(AVPacket *pkt);
  procedure av_free_packet(pkt: PAVPacket);                                     cdecl; external LIB_LIBAVCODEC;
{$endif}
(**
...
//                                 int size);
  function av_packet_new_side_data(pkt: PAVPacket; type_: TAVPacketSideDataType;
    size: Integer): PByte;                                                      cdecl; external LIB_LIBAVCODEC;
...
//                            uint8_t *data, size_t size);
  function av_packet_add_side_data(pkt: PAVPacket; type_: TAVPacketSideDataType;
    data: PByte; size: NativeUInt): Integer;                                    cdecl; external LIB_LIBAVCODEC;
...
//                               int size);
  function av_packet_shrink_side_data(pkt: PAVPacket;
    type_: TAVPacketSideDataType; size: Integer): Integer;                      cdecl; external LIB_LIBAVCODEC;
...
//                               int *size);
  function av_packet_get_side_data(const pkt: PAVPacket;
    type_: TAVPacketSideDataType; var size: Integer): PByte;                    cdecl; external LIB_LIBAVCODEC;

{$ifdef FF_API_MERGE_SD_API}
//attribute_deprecated
//int av_packet_merge_side_data(AVPacket *pkt);
  function av_packet_merge_side_data(pkt: PAVPacket): Integer;                  deprecated; cdecl; external LIB_LIBAVCODEC;

//attribute_deprecated
//int av_packet_split_side_data(AVPacket *pkt);
  function av_packet_split_side_data(pkt: PAVPacket): Integer;                  deprecated; cdecl; external LIB_LIBAVCODEC;
{$endif}

//const char *av_packet_side_data_name(enum AVPacketSideDataType type);
  function av_packet_side_data_name(type_: TAVPacketSideDataType): PAnsiChar;   cdecl; external LIB_LIBAVCODEC;
...
//uint8_t *av_packet_pack_dictionary(AVDictionary *dict, int *size);
  function av_packet_pack_dictionary(dict: PAVDictionary;
    var size: Integer): PByte;                                                  cdecl; external LIB_LIBAVCODEC;
...
//int av_packet_unpack_dictionary(const uint8_t *data, int size, AVDictionary **dict);
  function av_packet_unpack_dictionary(const data: PByte; size: Integer;
    dict: PPAVDictionary): Integer;                                             cdecl; external LIB_LIBAVCODEC;
...
//void av_packet_free_side_data(AVPacket *pkt);
  procedure av_packet_free_side_data(pkt: PAVPacket);                           cdecl; external LIB_LIBAVCODEC;
...
//int av_packet_ref(AVPacket *dst, const AVPacket *src);
  function av_packet_ref(dst: PAVPacket; const src: PAVPacket): Integer;        cdecl; external LIB_LIBAVCODEC;
...
//void av_packet_unref(AVPacket *pkt);
  procedure av_packet_unref(pkt: PAVPacket);                                    cdecl; external LIB_LIBAVCODEC;
...
//void av_packet_move_ref(AVPacket *dst, AVPacket *src);
  procedure av_packet_move_ref(dst: PAVPacket; src: PAVPacket);                 cdecl; external LIB_LIBAVCODEC;
...
function av_packet_copy_props(dst: PAVPacket; const src: PAVPacket): Integer;   cdecl; external LIB_LIBAVCODEC;
...
//void av_packet_rescale_ts(AVPacket *pkt, AVRational tb_src, AVRational tb_dst);
  procedure av_packet_rescale_ts(pkt: PAVPacket; tb_src, tb_dst: TAVRational);  cdecl; external LIB_LIBAVCODEC;
...
//AVCodec *avcodec_find_decoder(enum AVCodecID id);
  function avcodec_find_decoder(id: TAVCodecID): PAVCodec;                      cdecl; external LIB_LIBAVCODEC;
...
//AVCodec *avcodec_find_decoder_by_name(const char *name);
  function avcodec_find_decoder_by_name(const name: PAnsiChar): PAVCodec;       cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_default_get_buffer2(AVCodecContext *s, AVFrame *frame, int flags);
  function avcodec_default_get_buffer2(s: PAVCodecContext; frame: PAVFrame;
    flags: Integer): Integer;                                                   cdecl; external LIB_LIBAVCODEC;
...
//unsigned avcodec_get_edge_width(void);
  function avcodec_get_edge_width: Cardinal;                                    deprecated; cdecl; external LIB_LIBAVCODEC;
{$endif}
...
//void avcodec_align_dimensions(AVCodecContext *s, int *width, int *height);
  procedure avcodec_align_dimensions(s: PAVCodecContext; var width,
    height: Integer);                                                           cdecl; external LIB_LIBAVCODEC;
...
//                               int linesize_align[AV_NUM_DATA_POINTERS]);
  procedure avcodec_align_dimensions2(s: PAVCodecContext; var widht,
    height: Integer; linesize_align: array[0..AV_NUM_DATA_POINTERS - 1] of Integer); cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_enum_to_chroma_pos(int *xpos, int *ypos, enum AVChromaLocation pos);
  function avcodec_enum_to_chroma_pos(var xpos, ypos: Integer;
    pos: TAVChromaLocation): Integer;                                           cdecl; external LIB_LIBAVCODEC;
...
//enum AVChromaLocation avcodec_chroma_pos_to_enum(int xpos, int ypos);
  function avcodec_chroma_pos_to_enum(xpos, ypos: Integer): TAVChromaLocation;  cdecl; external LIB_LIBAVCODEC;
...
//                          int *got_frame_ptr, const AVPacket *avpkt);
  function avcodec_decode_audio4(avctx: PAVCodecContext; const frame: PAVPacket;
    var got_frame_ptr: Integer; avpkt: PAVPacket): Integer;                     deprecated; cdecl; external LIB_LIBAVCODEC;
...
//                         const AVPacket *avpkt);
  function avcodec_decode_video2(avctx: PAVCodecContext; picture: PAVFrame;
    var got_picture_ptr: Integer; const avpkt: PAVPacket): Integer;             deprecated; cdecl; external LIB_LIBAVCODEC;
...
//                            AVPacket *avpkt);
  function avcodec_decode_subtitle2(avctx: PAVCodecContext; sub: PAVSubtitle;
    var got_sub_ptr: Integer; avpkt: PAVPacket): Integer;                       cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_send_packet(AVCodecContext *avctx, const AVPacket *avpkt);
  function avcodec_send_packet(avctx: PAVCodecContext;
    const avpkt: PAVPacket): Integer;                                           cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_receive_frame(AVCodecContext *avctx, AVFrame *frame);
  function avcodec_receive_frame(avctx: PAVCodecContext;
    frame: PAVFrame): Integer;                                                  cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_send_frame(AVCodecContext *avctx, const AVFrame *frame);
  function avcodec_send_frame(avctx: PAVCodecContext;
    const frame: PAVFrame): Integer;                                            cdecl; external LIB_LIBAVCODEC;
...
//int avcodec_receive_packet(AVCodecContext *avctx, AVPacket *avpkt);
  function avcodec_receive_packet(avctx: PAVCodecContext;
    avpkt: PAVPacket): Integer;                                                 cdecl; external LIB_LIBAVCODEC;
...
{$ifdef FF_API_CONVERGENCE_DURATION}
     ...
     *)
//    attribute_deprecated
    convergence_duration: Int64 deprecated;
{$endif}
...
type
  ...
  TProcParserInit = function(s: PAVCodecParserContext): Integer; cdecl;
  TProcParserParse = function(s: PAVCodecParserContext; avctx: PAVCodecContext;
    var poutbuf: PByte; var poutbuf_size: Integer; const buf: PByte;
    buf_size: Integer): Integer; cdecl;
  TProcParserClose = procedure(s: PAVCodecParserContext); cdecl;
  TProcSplit = function(avctx: PAVCodecContext; const buf: PByte;
    buf_size: Integer): Integer; cdecl;
...
//                        const uint8_t *buf, int buf_size);
    parser_parse: TProcParserParse;

//void (*parser_close)(AVCodecParserContext *s);
    parser_close: TProcParserClose;
...
//AVCodecParser *av_parser_next(const AVCodecParser *c);
  function av_parser_next(const c: PAVCodecParser): PAVCodecParser;             cdecl; external LIB_LIBAVCODEC;

//void av_register_codec_parser(AVCodecParser *parser);
  procedure av_register_codec_parser(parser: PAVCodecParser);                   cdecl; external LIB_LIBAVCODEC;
//AVCodecParserContext *av_parser_init(int codec_id);
  function av_parser_init(codec_id: Integer): PAVCodecParserContext;            cdecl; external LIB_LIBAVCODEC;
...
//                     int64_t pos);
  function av_parser_parse2(s: PAVCodecParserContext; avctx: PAVCodecContext;
    var poutbuf: PByte; var poutbuf_size: Integer; const buf: PByte;
    buf_size: Integer; pts: Int64; dts: Int64; pos: Int64): Integer;            cdecl; external LIB_LIBAVCODEC;
...
//                     const uint8_t *buf, int buf_size, int keyframe);
  function av_parser_change(s: PAVCodecParserContext; avctx: PAVCodecContext;
    var poutbuf: PByte; var poutbuf_size: Integer; const buf: PByte;
    buf_size: Integer; keyframe: Integer): Integer;                             cdecl; external LIB_LIBAVCODEC;

//void av_parser_close(AVCodecParserContext *s);
  procedure av_parser_close(s: PAVCodecParserContext);                          cdecl; external LIB_LIBAVCODEC;
...
//AVCodec *avcodec_find_encoder(enum AVCodecID id);
  function avcodec_find_encoder(id: TAVCodecID): PAVCodec;                      cdecl; external LIB_LIBAVCODEC;
...
//AVCodec *avcodec_find_encoder_by_name(const char *name);
  function avcodec_find_encoder_by_name(const name: PAnsiChar): PAVCodec;
...
//                          const AVFrame *frame, int *got_packet_ptr);
  function avcodec_encode_audio2(avctx: PAVCodecContext; avpkt: PAVPacket;
    const frame: PAVFrame; var got_packet_ptr: Integer): Integer;               deprecated; cdecl; external LIB_LIBAVCODEC;
...
//                            const AVSubtitle *sub);
  function avcodec_encode_subtitle(avctx: PAVCodecContext; buf: PByte;
    buf_size: Integer; sub: TAVSubtitle): Integer;                              cdecl; external LIB_LIBAVCODEC;
...
//                                        int linear, double cutoff);
  function av_audio_resample_init(output_channels: Integer;
    input_channels: Integer; output_rate: Integer; input_rate: Integer;
    sample_fmt_out: TAVSampleFormat; sample_fmt_in: TAVSampleFormat;
    filter_length: Integer; log2_phase_count: Integer; linear: Integer;
    cutoff: Double): PReSampleContext;                                          deprecated; cdecl; external LIB_LIBAVCODEC;

//attribute_deprecated
//int audio_resample(ReSampleContext *s, short *output, short *input, int nb_samples);
  function audio_resample(s: PReSampleContext; output: PSmallInt;
    input: PSmallInt; nb_samples: Integer): Integer;                            deprecated; cdecl; external LIB_LIBAVCODEC;
...
//void audio_resample_close(ReSampleContext *s);
  procedure audio_resample_close(s: PReSampleContext);                          deprecated; cdecl; external LIB_LIBAVCODEC;
...
//struct AVResampleContext *av_resample_init(int out_rate, int in_rate, int filter_length, int log2_phase_count, int linear, double cutoff);
  function av_resample_init(out_rate: Integer; in_rate: Integer;
    filter_length: Integer; log2_phase_count: Integer; linear: Integer;
    cutoff: Double): PAVResampleContext;                                        deprecated; cdecl; external LIB_LIBAVCODEC;
...
//int av_resample(struct AVResampleContext *c, short *dst, short *src, int *consumed, int src_size, int dst_size, int update_ctx);
  function av_resample(c: PAVResampleContext; dst, src: PSmallInt;
    consumed: PInteger; src_size, dst_size, update_ctx: Integer): Integer;      deprecated; cdecl; external LIB_LIBAVCODEC;
...
//void av_resample_compensate(struct AVResampleContext *c, int sample_delta, int compensation_distance);
  procedure av_resample_compensate(c: PAVResampleContext; sample_delta,
    compensation_distance: Integer);                                            deprecated; cdecl; external LIB_LIBAVCODEC;

//attribute_deprecated
//void av_resample_close(struct AVResampleContext *c);
  procedure av_resample_close(AVResampleContext: PAVResampleContext);           deprecated; cdecl; external LIB_LIBAVCODEC;
...
//int avpicture_alloc(AVPicture *picture, enum AVPixelFormat pix_fmt, int width, int height);
  function avpicture_alloc(picture: PAVPicture; pix_fmt: TAVPixelFormat; width,
    height: Integer): Integer;                                                  deprecated; cdecl; external LIB_LIBAVCODEC;
...
//void avpicture_free(AVPicture *picture);
  procedure avpicture_free(picture: PAVPicture);                                deprecated; cdecl; external LIB_LIBAVCODEC;
...
//                   enum AVPixelFormat pix_fmt, int width, int height);
  function avpicture_fill(picture: PAVPicture; const ptr: PByte;
    pix_fmt: TAVPixelFormat; width, height: Integer): Integer;                  deprecated 'use av_image_fill_arrays() instead.'; cdecl; external LIB_LIBAVCODEC;
...
//                     unsigned char *dest, int dest_size);
  function avpicture_layout(const src: PAVPicture; pix_fmt: TAVPixelFormat;
    width, height: Integer; dest: PByte; dest_size: Integer): Integer;          deprecated 'use av_image_copy_to_buffer() instead.'; cdecl; external LIB_LIBAVCODEC;
...
//int avpicture_get_size(enum AVPixelFormat pix_fmt, int width, int height);
  function avpicture_get_size(pix_fmt: TAVPixelFormat; width,
    height: Integer): Integer;                                                  deprecated 'use av_image_get_buffer_size() instead.'; cdecl; external LIB_LIBAVCODEC;
...
//                     enum AVPixelFormat pix_fmt, int width, int height);
  procedure av_picture_copy(dst: PAVPicture; const src: PAVPicture;
    pix_fmt: TAVPixelFormat; width, height: Integer);                           deprecated 'use av_image_copy() instead.'; cdecl; external LIB_LIBAVCODEC;
...
//                    enum AVPixelFormat pix_fmt, int top_band, int left_band);
  function av_picture_crop(dst: PAVPicture; const src: PAVPicture;
    pix_fmt: TAVPixelFormat; top_band, left_band: Integer): Integer;            deprecated; cdecl; external LIB_LIBAVCODEC;
...
//            int padtop, int padbottom, int padleft, int padright, int *color);
  function av_picture_pad(dst: PAVPicture; const src: PAVPicture; height,
    width: Integer; pix_fmt: TAVPixelFormat; padtop, padbottom, padleft,
    padright: Integer; color: PInteger): Integer;                               deprecated; cdecl; external LIB_LIBAVCODEC;
...
//void avcodec_get_chroma_sub_sample(enum AVPixelFormat pix_fmt, int *h_shift, int *v_shift);
  procedure avcodec_get_chroma_sub_sample(pix_fmt: TAVPixelFormat; var h_shift,
    v_shift: Integer);                                                          deprecated; cdecl; external LIB_LIBAVCODEC;
{$endif}
...
//unsigned int avcodec_pix_fmt_to_codec_tag(enum AVPixelFormat pix_fmt);
  function avcodec_pix_fmt_to_codec_tag(pix_fmt: TAVPixelFormat): Cardinal;     cdecl; external LIB_LIBAVCODEC;
...
//                             int has_alpha);
  function avcodec_get_pix_fmt_loss(dst_pix_fmt, src_pix_fmt: TAVPixelFormat;
    has_alpha: Integer): Integer;                                               cdecl; external LIB_LIBAVCODEC;
...
//                                            int has_alpha, int *loss_ptr);
  function avcodec_find_best_pix_fmt_of_list(const pix_fmt_list: PAVPixelFormat;
    src_pix_fmt: TAVPixelFormat; has_alpha: Integer;
    loss_ptr: PInteger): TAVPixelFormat;                                        cdecl; external LIB_LIBAVCODEC;
...
//                                            enum AVPixelFormat src_pix_fmt, int has_alpha, int *loss_ptr);
  function avcodec_find_best_pix_fmt_of_2(dst_pix_fmt1, dst_pix_fmt2,
    src_pix_fmt: TAVPixelFormat; has_alpha: Integer;
    loss_ptr: PInteger): TAVPixelFormat;                                        deprecated 'see av_find_best_pix_fmt_of_2()'; cdecl; external LIB_LIBAVCODEC;

//attribute_deprecated
//enum AVPixelFormat avcodec_find_best_pix_fmt2(enum AVPixelFormat dst_pix_fmt1, enum AVPixelFormat dst_pix_fmt2,
//                                            enum AVPixelFormat src_pix_fmt, int has_alpha, int *loss_ptr);
  function avcodec_find_best_pix_fmt2(dst_pix_fmt1, dst_pix_fmt2,
    src_pix_fmt: TAVPixelFormat; has_alpha: Integer;
    loss_ptr: PInteger): TAVPixelFormat;                                        deprecated; cdecl; external LIB_LIBAVCODEC;

//enum AVPixelFormat avcodec_default_get_format(struct AVCodecContext *s, const enum AVPixelFormat * fmt);
  function avcodec_default_get_format(s: PAVCodecContext;
    const fmt: PAVPixelFormat): TAVPixelFormat;                                 cdecl; external LIB_LIBAVCODEC;
...
//void avcodec_set_dimensions(AVCodecContext *s, int width, int height);
  procedure avcodec_set_dimensions(s: PAVCodecContext; width, height: Integer); cdecl; external LIB_LIBAVCODEC;
{$endif}
...
//size_t av_get_codec_tag_string(char *buf, size_t buf_size, unsigned int codec_tag);
  function av_get_codec_tag_string(buf: PAnsiChar; buf_size: NativeUInt;
    codec_tag: Cardinal): NativeUInt;                                           cdecl; external LIB_LIBAVCODEC;
{$endif}

//void avcodec_string(char *buf, int buf_size, AVCodecContext *enc, int encode);
  procedure avcodec_string(buf: PAnsiChar; buf_size: Integer;
    enc: PAVCodecContext; encode: Integer);                                     cdecl; external LIB_LIBAVCODEC;
...
//const char *av_get_profile_name(const AVCodec *codec, int profile);
  function av_get_profile_name(const codec: PAVCodec;
    profile: Integer): PAnsiChar;                                               cdecl; external LIB_LIBAVCODEC;
...
//const char *avcodec_profile_name(enum AVCodecID codec_id, int profile);
  function avcodec_profile_name(codec_id: TAVCodecID;
    profile: Integer): PAnsiChar;                                               cdecl; external LIB_LIBAVCODEC;

//int avcodec_default_execute(AVCodecContext *c, int (*func)(AVCodecContext *c2, void *arg2),void *arg, int *ret, int count, int size);
type
  TProcFuncavcodec_default_execute = function (c2: PAVCodecContext;
    arg2: Pointer): Integer; cdecl;

  function avcodec_default_execute(c: PAVCodecContext;
    func: TProcFuncavcodec_default_execute; arg: Pointer; var ret: Integer;
    count, size: Integer): Integer;                                             cdecl; external LIB_LIBAVCODEC;

//int avcodec_default_execute2(AVCodecContext *c, int (*func)(AVCodecContext *c2, void *arg2, int, int),void *arg, int *ret, int count);
type
  TProcFuncavcodec_default_execute2 = function(c2: PAVCodecContext;
    arg2: Pointer; i1, i2: Integer): Integer; cdecl;

  function avcodec_default_execute2(c: PAVCodecContext;
  func: TProcFuncavcodec_default_execute2; arg: Pointer; var ret: Integer;
  count: Integer): Integer;                                                     cdecl; external LIB_LIBAVCODEC;
//FIXME func typedef
...
//                             int buf_size, int align);
  function avcodec_fill_audio_frame(framr: PAVFrame; nb_channels: Integer;
    sample_fmt: TAVSampleFormat; const buf: PByte; buf_size,
    align: Integer): Integer;                                                   cdecl; external LIB_LIBAVCODEC;
...
//int av_get_bits_per_sample(enum AVCodecID codec_id);
  function av_get_bits_per_sample(codec_id: TAVCodecID): Integer;               cdecl; external LIB_LIBAVCODEC;
...
//enum AVCodecID av_get_pcm_codec(enum AVSampleFormat fmt, int be);
  function av_get_pcm_codec(fmt: TAVSampleFormat; be: Integer): TAVCodecID;     cdecl; external LIB_LIBAVCODEC;
...
//int av_get_exact_bits_per_sample(enum AVCodecID codec_id);
  function av_get_exact_bits_per_sample(codec_id: TAVCodecID): Integer;         cdecl; external LIB_LIBAVCODEC;
...
//int av_get_audio_frame_duration(AVCodecContext *avctx, int frame_bytes);
  function av_get_audio_frame_duration(avctx: PAVCodecContext;
    frame_bytes: Integer): Integer;                                             cdecl; external LIB_LIBAVCODEC;
...
//int av_get_audio_frame_duration2(AVCodecParameters *par, int frame_bytes);
  function av_get_audio_frame_duration2(par: PAVCodecParameters;
    frame_bytes: Integer): Integer;                                             cdecl; external LIB_LIBAVCODEC;
...
type
  TProcAVBitStreamFilterInit = function(ctx: PAVBSFContext): Integer; cdecl;
  TProcAVBitStreamFilterClose = function(ctx: PAVBSFContext): Integer; cdecl;
  TProcAVBitStreamFilterFilter = function(ctx: PAVBSFContext;
...
//int (*init)(AVBSFContext *ctx);
    init: TProcAVBitStreamFilterInit;
//int (*filter)(AVBSFContext *ctx, AVPacket *pkt);
    filter: TProcAVBitStreamFilterFilter;
//void (*close)(AVBSFContext *ctx);
    close: TProcAVBitStreamFilterClose;
  end;
...
procedure av_register_bitstream_filter(bsf: PAVBitStreamFilter);                deprecated; cdecl; external LIB_LIBAVCODEC;
...
function av_bitstream_filter_init(const name: PAnsiChar): PAVBitStreamFilterContext; cdecl; external LIB_LIBAVCODEC;
...
function av_bitstream_filter_filter(bsfc: PAVBitStreamFilterContext;
  avctx: PAVCodecContext; const args: PAnsiChar; var poutbuf: PByte;
  poutbuf_size: PInteger; const buf: PByte; buf_size: Integer;
  keyframe: Integer): Integer;                                                  deprecated; cdecl; external LIB_LIBAVCODEC;
...
procedure av_bitstream_filter_close(bsf: PAVBitStreamFilterContext);            deprecated; cdecl; external LIB_LIBAVCODEC;
...
function av_bitstream_filter_next(const f: PAVBitStreamFilter): PAVBitStreamFilter; deprecated; cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_get_by_name(const name: PAnsiChar): PAVBitStreamFilter; cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_next(opaque: PPointer): PAVBitStreamFilter;                     cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_alloc(const filter: PAVBitStreamFilter; ctx: PPAVBSFContext): Integer; cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_init(ctx: PAVBSFContext): Integer;                              cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_send_packet(ctx: PAVBSFContext; pkt: PAVPacket): Integer;       cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_receive_packet(ctx: PAVBSFContext; pkt: PAVPacket): Integer;    cdecl; external LIB_LIBAVCODEC;
...
procedure av_bsf_free(var ctx: PAVBSFContext);                                  cdecl; external LIB_LIBAVCODEC;
...
procedure av_bsf_list_free(lst: PPAVBSFList);                                   cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_list_append(lst: PAVBSFList; bsf: PAVBSFContext): Integer;      cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_list_append2(lst: PAVBSFList; const bsf_name: PAnsiChar;
  options: PPAVDictionary): Integer;                                            cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_list_finalize(lst: PPAVBSFList; bsf: PPAVBSFContext): Integer;  cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_list_parse_str(const str: PAnsiChar; bsf: PPAVBSFContext): Integer; cdecl; external LIB_LIBAVCODEC;
...
function av_bsf_get_null_filter(bsf: PPAVBSFContext): Integer;                  cdecl; external LIB_LIBAVCODEC;
...
procedure av_fast_padded_malloc(ptr: Pointer; size: PInteger; min_size: NativeUInt); cdecl; external LIB_LIBAVCODEC;
...
procedure av_fast_padded_mallocz(ptr: Pointer; size: PInteger; min_size: NativeUInt); cdecl; external LIB_LIBAVCODEC;
...
function av_xiphlacing(s: PAnsiChar; v: Cardinal): Cardinal;                    cdecl; external LIB_LIBAVCODEC;
...
procedure av_log_missing_feature(avc: Pointer; const feature: PAnsiChar;
  want_sample: Integer);                                                        deprecated; cdecl; external LIB_LIBAVCODEC;
...
procedure av_log_ask_for_sample(avc: Pointer; const msg: PAnsiChar;
  args: PPointer);                                                              deprecated; cdecl; external LIB_LIBAVCODEC;
...
procedure av_register_hwaccel(hwaccel: PAVHWAccel);                             cdecl; external LIB_LIBAVCODEC;
...
function av_hwaccel_next(const hwaccel: PAVHWAccel): PAVHWAccel;                cdecl; external LIB_LIBAVCODEC;
...
type
  TProcav_lockmgr_register = function(mutex: PPointer; op: TAVLockOp): Integer; cdecl;

function av_lockmgr_register(cb: TProcav_lockmgr_register): Integer;            cdecl; external LIB_LIBAVCODEC;

(**
 * Get the type of the given codec.
 *)
//enum AVMediaType avcodec_get_type(enum AVCodecID codec_id);
function avcodec_get_type(codec_id: TAVCodecID): TAVMediaType;                  cdecl; external LIB_LIBAVCODEC;
...
function avcodec_get_name(id: TAVCodecID): PAnsiChar;                           cdecl; external LIB_LIBAVCODEC;
...
function avcodec_is_open(s: PAVCodecContext): Integer;                          cdecl; external LIB_LIBAVCODEC;

(**
 * @return a non-zero number if codec is an encoder, zero otherwise
 *)
//int av_codec_is_encoder(const AVCodec *codec);
function av_codec_is_encoder(const codec: PAVCodec): Integer;                   cdecl; external LIB_LIBAVCODEC;

(**
 * @return a non-zero number if codec is a decoder, zero otherwise
 *)
//int av_codec_is_decoder(const AVCodec *codec);
function av_codec_is_decoder(const codec: PAVCodec): Integer;                   cdecl; external LIB_LIBAVCODEC;

(**
 * @return descriptor for given codec ID or NULL if no descriptor exists.
 *)
//const AVCodecDescriptor *avcodec_descriptor_get(enum AVCodecID id);
function avcodec_descriptor_get(id: TAVCodecID): PAVCodecDescriptor;            cdecl; external LIB_LIBAVCODEC;
...
function avcodec_descriptor_next(const prev: PAVCodecDescriptor): PAVCodecDescriptor; cdecl; external LIB_LIBAVCODEC;
...
function avcodec_descriptor_get_by_name(const name: PAnsiChar): PAVCodecDescriptor; cdecl; external LIB_LIBAVCODEC;
...
function av_cpb_properties_alloc(size: PNativeUInt): PAVCPBProperties;          cdecl; external LIB_LIBAVCODEC;
